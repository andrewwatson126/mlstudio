...
const Dashboard = () => {
  ...
  const buildProjectItems = (project) => {
    const { name, icon } = project;

    return (
      <ListItem button key={name} onClick={() => history.push('/')}>
        <ListItemIcon>
          {icon}
        </ListItemIcon>
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      >
        ...
        <Divider />
        <List>
          { mainItems.map((project) => ( buildProjectItems(project))) }
        </List>
        <Divider />
        <List>
          { projectItems.map((project) => ( buildProjectItems(project))) }
        </List>
      </Drawer>
      <Box
        component="main"
